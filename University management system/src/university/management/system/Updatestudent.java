...
public class Updatestudent extends JFrame implements ActionListener{
    ...
    Updatestudent() {
        ...
        try {
            ...
            while(rs.next()) {
                ...
                tfcourse.setText(rs.getString("uscource"));
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            String uscource = tfcourse.getText();
            String branch = tfbranch.getText();
            
            try {
                String query = "update student set address='"+address+"', phonenumber='"+phonenumber+"', emailid='"+emailid+"', uscource='"+uscource+"', branch='"+branch+"' where rollnum='"+rollnum+"'";
                Conn con = new Conn();
