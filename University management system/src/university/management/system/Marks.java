...
public class Marks extends JFrame implements ActionListener {
    ...
    Marks(String rollnum) {
        ...
        JLabel lblrollno = new JLabel("Roll Number " + rollnum);
        ...
        try {
            ...
            ResultSet rs1 = c.s.executeQuery("select * from subject where rollnum = '"+rollno+"'");
            while(rs1.next()) {
           ...
           ResultSet rs2 = c.s.executeQuery("select * from marks where rollnum = '"+rollnum+"'");
            while(rs2.next()) {
