...
public class UpdateTeacher extends JFrame implements ActionListener{
    ...
    UpdateTeacher() {
        ...
        JLabel lblrollnumber = new JLabel("Select Employeeid");
        ...
        JLabel lblcourse = new JLabel("Qualifiaction");
        ...
        try {
            ...
            while(rs.next()) {
                ...
                labelaadhar.setText(rs.getString("adharnum"));
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            try {
                String query = "update teacher set address='"+address+"', phonenumber='"+phonenumber+"', emailid='"+emailid+"', qualification='"+qualification+"', department='"+department+"' where empid='"+empid+"'";
                Conn con = new Conn();
